...
const page = () => {
    ...
    <div className="min-w-screen min-h-screen bg-white flex items-center justify-center px-5 py-5">
      {loggedIn ? (
       <div className="middle">
        ...
        <div className="bg-white text-black rounded-3xl shadow-xl w-full overflow-hidden" style={{ maxWidth: "1300px" }}>
  ...
  />
            ...
            <div className="w-full md:w-1/2 py-10 px-10">
              ...
              <div className="mb-4">
                <label htmlFor="email" className="block mb-2 text-sm font-medium text-black">Email</label> {/* Changed text-gray-900 to text-black */}
                <input
                  type="email"
                  id="email"
                  value={email}
              ...
              <div className="mb-4">
                <label htmlFor="password" className="block mb-2 text-sm font-medium text-black">Password</label> {/* Changed text-gray-900 to text-black */}
                <input
                  type="password"
                  id="password"
                  value={password}
            ...
            <p className="text-center mt-3">Don't have an account? <span className="text-hover-obgreen cursor-pointer" onClick={() => router.push("/Login")}>Sign up now</span></p>
</div>
          </div>
        </div>
      )}
